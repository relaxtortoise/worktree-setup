...
| `internal/config/` | Three-layer config merge |
| `internal/worktree/` | Worktree create/remove orchestration |
| `internal/engine/` | Event lifecycle engine |
| `internal/actions/` | Step executors (scripts, copies, symlinks) |
| `internal/git/` | Git command wrappers |
| `internal/hooks/` | Git hook installer |
| `internal/tui/` | Interactive selectors |
